...
export default class PatientMyReport extends React.Component{
    render(){
        return(
            <React.Fragment>
                <Container >
             ...
             <div className="row  align-items-center ">
                 <div className="col-md-6"> <Breadcrumb url="" chlidrenUrl="" text="My Reports" />       </div>
...
<div className="row mt-4">
    ...
    <h1 className="fs-4 mb-1">My Reports</h1>
