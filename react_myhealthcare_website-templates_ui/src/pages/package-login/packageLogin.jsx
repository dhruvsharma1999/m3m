...
export default class PackageLogin extends React.Component{
  constructor(props){
    super(props);
    this.state={
        modal:false,
    ...
    <Accordion.Body className="p-3">
       ...
       <h6 className="fs-6 mb-0 mt-0 mt-2 date-time">Select Time Slot</h6>
           <ul className="list-unstyled d-flex flex-wrap mb-0 mt-3">
                ...
                <li>
                    <button className="btn time-slot-btn selected">
                    8:00 AM - 8:30 AM
                    </button>
                </li>
                <li>
...
Sarai, New Delhi, 110016</span></div>
              ...
              <div className="row border-bottom">
                    ...
                    <div className="col-auto">     <span >:</span>   </div>                             
                    <div  className="col-6"><span className="fw-bold">Sunita 35 Yrs, F, Wife</span></div>
                    </div>
                    <div className="row mt-2">
                    <div className="col-6"><span >Aarogyam 1.2</span></div>           
