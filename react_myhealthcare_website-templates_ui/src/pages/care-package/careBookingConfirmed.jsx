...
export default class CareBookingConfirmed extends React.Component{
                   ...
                   <div className="mhc-package-details-confirm">                
                     <div className="mhc-test-details">
                         ...
                         <div className="right-column">
                             <ul className="mb-0">
                                 <li>Covid Care 15 Days <i className="mhc-icon icon-mhc-info cursor-pointer text-primary"></i></li>
