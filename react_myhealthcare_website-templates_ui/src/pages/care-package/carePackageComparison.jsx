...
export default class CarePackageComparison extends React.Component{
    render(){
        return(
            <React.Fragment>
                                        ...
                                        <th>
                                            <div className='row'>
                                                <div className='col-8 col-sm-7'>
                                                    <h6 className="mb-0">Cardiac Care Program   </h6>
                                                    <span className="fw-normal fs-13">Starting at INR 4,999</span>
                                                </div>
                                            ...
                                            <div className='row mt-3 justify-content-end'>
                                                ...
                                                <div className="col-12 text-end">
                                                    <Link to="/care-package-login" className="btn btn-primary rounded-1  px-4" >Book</Link>
                                                </div>
                                            </div>
                                        </th>
                                        <th>
