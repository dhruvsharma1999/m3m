...
export default class CarePackageLogin extends React.Component{
  constructor(props){
    super(props);
    this.state={
        modal:false,
...
Sarai, New Delhi, 110016</span></div>
                    ...
                    <div className="col-auto">     <span >:</span>   </div>              
                    <div className="col-6"><span className="fw-bold text-primary">Fri, 1 Nov 2021</span></div>
                    </div>
              </div>
              ...
              <div className="row border-bottom">
                    ...
                    <div className="row mt-2">
                    <div className="col-6"><span >Cardiac Care Program</span> <i className="mhc-icon icon-mhc-info cursor-pointer text-primary"></i></div>           
...
<div className="col-md-3 col-lg-3 col-xl-2 mt-2 mt-md-0">
    <a href="" className="btn btn-outline-secondary w-100 rounded-1 bg-white">Apply</a>
                ...
                <div className="row mt-2">
                    ...
                    <div  className="col-6 text-end"><span className="me-1">:</span><span className="fw-bold">INR 4,999 </span></div>
                    </div>
                    <div className="row mt-2">
  ...
  <input className="form-check-input" type="checkbox" defaultValue="" id="MyWallet" checked  />
  ...
  Use MyWallet for Payment 
                    ...
                    <div className="col-6 text-end"><span className="fw-bold ">INR 4,999</span></div>
                    </div>
